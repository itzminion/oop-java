...
class Main{
	public static void main(String args[]){
		...
		System.out.println("Volume of " + cylinder.getName() + "\t: " + cylinder.area() ) ; 
		System.out.println("Volume of " + sphere.getName() + "\t: " + sphere.area() ) ; 
		System.out.println("Volume of " + cube.getName() + "\t\t: " + cube.area() ) ; 
		System.out.println("Volume of " + glome.getName() + "\t\t: " + glome.area() ) ; 
	}
}
